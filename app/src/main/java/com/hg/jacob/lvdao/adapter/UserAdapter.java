...
public class UserAdapter extends BaseAdapter implements Filterable {
    ...
    private List<User> sdfs =new ArrayList<>();
        ...
        holder.list_item.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (holder.stub.getVisibility() ==View.GONE){
                    ...
                    switch (position){
                        case 0:
                            ...
                            holder.btn1.setOnClickListener(new View.OnClickListener() {
                                @Override
                                public void onClick(View view) {
                                   holder.btn1.setBackgroundResource(R.drawable.bg_new_btn);
                                    holder.btn2.setBackgroundResource(R.drawable.bg_new_btn_clear);
                                    holder.btn3.setBackgroundResource(R.drawable.bg_new_btn_clear);
                   ...
                   /* switch (position){
                        case 0:
                            if (sdfs !=null && sdfs.size()>0){
                                sdfs.clear();
                                int c = (int) (Math.random()*10);
                                for (int i = 0; i <c ; i++) {
                                    sdfs.add(new User("11"));
                                }
                            }else {
                                int c = (int) (Math.random()*10);
                                for (int i = 0; i <c ; i++) {
                  ...
                  BtnAdapter adapter =new BtnAdapter(mContext);
                    adapter.setList(sdfs);
