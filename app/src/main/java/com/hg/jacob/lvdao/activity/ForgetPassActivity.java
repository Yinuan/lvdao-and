...
public class ForgetPassActivity extends BaseActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title.setText(getResources().getString(R.string.find_pass));
        //设置新的密码提示
        registPass.setHint(getResources().getString(R.string.login_newpass));
        registPassAgin.setHint(getResources().getString(R.string.login_napass));

        //设置edittext获取焦点时，隐藏提示文字
        setHint();
    }
